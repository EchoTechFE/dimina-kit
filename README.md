...
- [`@dimina-kit/workbench`](./packages/workbench) — 内嵌式 VS Code 工作台编辑器（`@codingame/monaco-vscode-api`），带 WXML 语言特性、dd/wx 类型提示与 dimina 配置 JSON Schema，可由 devtools 与 web 客户端共用
