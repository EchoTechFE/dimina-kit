...
function makeHarness() {
  ...
  const ctx = {
    ...
    views: { disposeProjectViews: vi.fn(), disposeAll: vi.fn(), detachWorkbench: vi.fn(), detachSimulator: vi.fn(), holdWorkbenchAttach: vi.fn(() => vi.fn()), cancelWorkbenchAttachHold: vi.fn() },
