...
import { findElementBySid, type WxmlNode } from '@dimina-kit/wxml-inspect'
...
export type { WxmlNode } from '@dimina-kit/wxml-inspect'
export { registerSyntheticSid } from '@dimina-kit/wxml-inspect'
